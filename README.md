...
| `log_location_period`         | `POST /locations`                      | Record where the athlete is over a date range ("Mallorca, July 20–28") so weather/heat reads resolve there instead of home. Agent supplies city-grade coordinates. Overlaps fine — latest start wins. No edit: delete + re-log. |
