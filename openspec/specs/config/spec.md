...
Define how configuration is loaded, validated, and prioritized across the nutrition API binary, centralizing env/flag/default precedence in a shared Viper-backed `internal/config` package and protecting secret values from leaking through logs.
## Requirements
