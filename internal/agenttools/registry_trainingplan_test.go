...
func TestTrainingPlan_SurfaceAndTiers(t *testing.T) {
	...
	wantTier := map[string]Tier{
		...
		"delete_training_plan":      TierWriteConfirm,
		"add_plan_week":             TierWriteAuto,
		"patch_plan_week":           TierWriteAuto,
		"delete_plan_week":          TierWriteConfirm,
		"add_plan_slot":             TierWriteConfirm,
		"patch_plan_slot":           TierWriteConfirm,
		"delete_plan_slot":          TierWriteConfirm,
		"materialize_training_plan": TierWriteConfirm,
