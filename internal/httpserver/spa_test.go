...
// unit fixtures above and what the compiled binary ships. It is the automatable
// half of the manual smoke (task 7.5): the binary embeds and serves the shell +
// a real hashed asset. The browser-prompt-over-Tailscale-with-live-data half
// remains a manual operator confirmation (documented in RUN_LOCAL.md).
