    ...
    "paths": {
        ...
        "/athlete-config": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\\\"athlete_config\\\": AthleteConfig | null, \\\"sources\\\": [string]}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "put": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "forbidden — the garmin identity cannot write the deliberate config",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/athlete-config/effective": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "{\\\"effective\\\": EffectiveConfig | null}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/athlete-config/garmin-detected": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "{\\\"garmin_detected\\\": GarminDetectedThresholds | null}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Detected thresholds payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/athleteconfig.GarminDetectedThresholds"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "{\\\"garmin_detected\\\": GarminDetectedThresholds}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "403": {
                        "description": "forbidden — only the garmin identity may write detections",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/athlete-config/sources": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Source policy payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/athleteconfig.sourcesRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "source_field_invalid | invalid_json | idempotency_unsupported_for_put",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "403": {
                        "description": "forbidden — the garmin identity cannot set the policy",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/locations": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "name_required | lat_lon_invalid | date_invalid | range_invalid | note_too_long | place_not_found | invalid_json",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/workouts/{id}/fueling-plan": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "number",
                        "description": "Tested gut capacity in g/hr (\u003e 0, \u003c= 130); clamps the prescription's upper bound",
                        "name": "carbs_per_hr",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/workoutfueling.FuelingPlan"
                        }
                    },
                    "400": {
                        "description": "carbs_per_hr_invalid",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
                    ...
                    "409": {
                        "description": "workout_not_planned",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
    ...
    "definitions": {
        ...
        "athleteconfig.EffectiveConfig": {
            ...
            "properties": {
                ...
                "field_sources": {
                    "description": "FieldSources maps each physiology field's JSON name to \"manual\" or\n\"garmin\" — the provenance of the resolved value.",
                    "type": "object",
                    "additionalProperties": {
                        "type": "string"
                    }
        ...
        "athleteconfig.GarminDetectedThresholds": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "coachcontext.TrainingContext": {
            ...
            "properties": {
                ...
                "effective": {
                    "description": "Effective is the resolved physiology computations actually consume (config\nwith garmin-sourced fields swapped for the detection, per-field annotated);\nnull when neither a config nor an applied detection exists.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/athleteconfig.EffectiveConfig"
                        }
                    ]
                },
                "fitness": {
                ...
                "threshold_sources": {
                    "description": "ThresholdSources is the active garmin-sourced field policy — which fields\ncomputations read from Garmin instead of the confirmed config; empty slice\nwhen all-manual.",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "dailycontext.HeatBlock": {
            "type": "object",
            "properties": {
                "today": {
                    "$ref": "#/definitions/dailycontext.HeatDay"
                },
                "tomorrow": {
                    "$ref": "#/definitions/dailycontext.HeatDay"
                }
        ...
        "heat.AcclimEvidence": {
            ...
            "properties": {
                "level": {
                    "$ref": "#/definitions/heat.Acclimatization"
                },
                "qualifying_sessions": {
                    "type": "integer"
                },
                "sessions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/heat.QualifyingSession"
                    }
                },
                "window_days": {
                    "type": "integer"
        ...
        "heat.FluidNote": {
            ...
            "properties": {
                ...
                "source": {
                    "description": "Source states where the number came from — a flagged default is honest, a\nsilent one would not be. See the Source* constants.",
                    "type": "string"
                }
            }
        },
        ...
        "heat.Report": {
            ...
            "properties": {
                "acclimatization": {
                    "$ref": "#/definitions/heat.AcclimEvidence"
                },
                "assumed_outdoor": {
                    "type": "boolean"
                },
                ...
                "fluid": {
                    "$ref": "#/definitions/heat.FluidNote"
                },
                "load": {
                    "$ref": "#/definitions/heat.Load"
                },
                "location": {
                    "$ref": "#/definitions/heat.Location"
                },
                "not_applicable": {
                    "type": "boolean"
                },
        ...
        "workoutfueling.FuelingPlan": {
            "type": "object",
            "properties": {
                "estimated_carb_burn_g": {
                    "type": "number"
                },
                "estimated_kcal": {
                    "type": "number"
                ...
                "inputs": {
                    "$ref": "#/definitions/workoutfueling.FuelingPlanInputs"
                },
                "prescription": {
                    "$ref": "#/definitions/workoutfueling.Prescription"
                },
                "projected_deficit_g": {
                    "type": "number"
                },
        ...
        "workoutfueling.FuelingPlanInputs": {
            "type": "object",
            "properties": {
                "carbs_per_hr_limit": {
                    "type": "number"
